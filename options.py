...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--model_name",
                                 ...
                                 default="Kitti")
        self.parser.add_argument("--splits",
                                 type=str,
                                 help="which training splits to use",
                                 default="eigen_zhou")
        ...
        self.parser.add_argument("--eval_split",
                                 type=str,
                                 default="eigen",
                                 help="which splits to run eval on")
        ...
        #fusion
        self.parser.add_argument("--disable_fusion",action='store_true',default=True)
        # DDP
        self.parser.add_argument("--local_"
                                 "rank", default=0,type=int)
        self.parser.add_argument("--ddp", 
                                  help="Use DistributedDataParallel",
                                  action="store_true",default=True)

        #self.parser.add_argument("--load_dynamic_mask",action="store_true")

        self.parser.add_argument("--text_prompt", type=str, default='van. car . people . motocycle . bicycle', help="text prompt")
        self.parser.add_argument(
            "--output_dir", "-o", type=str, default="outputs", help="output directory"
        )

        self.parser.add_argument("--box_threshold", type=float, default=0.3, help="box threshold")
        self.parser.add_argument("--text_threshold", type=float, default=0.25, help="text threshold")

        self.parser.add_argument("--device", type=str, default="cuda", help="running on cpu only!, default=False")
        self.parser.add_argument("--load_dynamic_mask", action='store_true', default=True)
        self.parser.add_argument('--save_ply', default=True)
        self.parser.add_argument('--save_vis', default=True)
